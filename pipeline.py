...
LUA_SHA1 = get_hash(os.path.join(CWD, 'layervault.lua'))
...
project = Project(
    title="layervault",
    project_html="""
        <img class="project-logo" alt="Project logo" src="http://archiveteam.org/images/f/fb/LayerVaultLogo.png" height="50px" title=""/>
        <h2>layervault <span class="links"><a href="http://layervault.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/layervault/">Leaderboard</a></span></h2>
        <p>Grabbing all accounts from layervault.com.</p>
    """
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="layervault"),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
